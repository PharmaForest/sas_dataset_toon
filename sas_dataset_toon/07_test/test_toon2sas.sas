...
%sas2toon(libname=WORK, dataset=original_employees, 
          outfile=&outpath./roundtrip_employees.toon);

%* Convert back to SAS;
%toon2sas(infile=&outpath./roundtrip_employees.toon, 
...
%sas2toon(libname=WORK, dataset=original_codes, outfile=&outpath./roundtrip_codes.toon);
%toon2sas(infile=&outpath./roundtrip_codes.toon, libname=WORK, dataset=restored_codes);
...
%* Round-trip conversion;
%sas2toon(libname=WORK, dataset=original_empty, outfile=&outpath./roundtrip_empty.toon);
%toon2sas(infile=&outpath./roundtrip_empty.toon, libname=WORK, dataset=restored_empty);
...
%* Round-trip conversion;
%sas2toon(libname=WORK, dataset=original_special, outfile=&outpath./roundtrip_special.toon);
%toon2sas(infile=&outpath./roundtrip_special.toon, libname=WORK, dataset=restored_special);
...
%* Round-trip conversion;
%sas2toon(libname=WORK, dataset=original_dates, outfile=&outpath./roundtrip_dates.toon);
%toon2sas(infile=&outpath./roundtrip_dates.toon, libname=WORK, dataset=restored_dates);
