...
%* Convert to TOON;
%sas2toon(libname=WORK, dataset=test_employees, outfile=&outpath./test_employees.toon);

%* Verify TOON file exists;
%if %sysfunc(fileexist(&outpath./test_employees.toon)) %then %do;
...
%sas2toon(libname=WORK, dataset=test_special_chars, outfile=&outpath./test_special.toon);

%* Verify file created;
%if %sysfunc(fileexist(&outpath./test_special.toon)) %then %do;
...
%sas2toon(libname=WORK, dataset=test_leading_zeros, outfile=&outpath./test_leading_zeros.toon);

%* Verify file created;
%if %sysfunc(fileexist(&outpath./test_leading_zeros.toon)) %then %do;
...
%sas2toon(libname=WORK, dataset=test_missing, outfile=&outpath./test_missing.toon);

%* Verify file created;
%if %sysfunc(fileexist(&outpath./test_missing.toon)) %then %do;
...
%sas2toon(libname=WORK, dataset=test_dates, outfile=&outpath./test_dates.toon);

%* Verify file created;
%if %sysfunc(fileexist(&outpath./test_dates.toon)) %then %do;
